    ...
    <header class="navbar shadow-sm sticky top-0 z-50">
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div class="hidden lg:flex lg:gap-x-8">
          <a href="#" class="text-sm font-semibold text-blue-600 border-b-2 border-blue-600 pb-1">Beranda</a>
    ...
    <section class="my-bg text-white py-16">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-6">
          <div class="w-full">
            <h1 class="text-4xl lg:text-5xl font-bold mb-4 max-w-4xl">Selamat Datang Di Museum Karya Smk Negeri 4 Tasikmalaya</h1>
          </div>

          <div class="py-1">
            <!-- Teks deskripsi sekarang bisa memanjang ke kanan -->
            <p class="text-xl text-gray-200 mb-1 w-full">Eksplorasi karya Siswa Dalam Bidang Software dan Game</p>
            ...
            <div class="flex flex-wrap mt-5 gap-4">
              <button class="px-6 py-3 border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition">Login untuk Upload Karya</button>
              <button class="px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Telusuri Karya Siswa</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mb-12">
          ...
          <div class="flex gap-3">
            <input type="text" placeholder="Cari judul, deskripsi, atau kata kunci..." class="flex-1 px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" />
            <button class="px-8 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Cari Karya</button>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 bg-white">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="flex items-center justify-between mb-12">
          ...
          <a href="karya.html" class="text-blue-600 font-semibold hover:text-blue-700 flex items-center gap-1"> Lihat Semua → </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
            <div class="bg-gradient-to-br from-yellow-400 to-orange-400 h-48 flex items-center justify-center text-center p-4">
              <div>
            ...
            <div class="p-6">
              <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-3 py-1 rounded-full mb-3">Website</span>
              ...
              <button class="w-full py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition flex items-center justify-center gap-2">
          ...
          <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
            ...
            <div class="p-6">
              <span class="inline-block bg-gray-200 text-gray-700 text-xs font-semibold px-3 py-1 rounded-full mb-3"> Game </span>
              <p class="text-gray-600 text-sm mb-4">
          ...
          <!-- CARD 3 -->
          <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
            <div class="bg-gradient-to-br from-blue-400 to-blue-600 h-48 flex items-center justify-center text-center p-4">
              <div>
