        ...
        <div class="flex-1 overflow-auto p-8 space-y-6 relative">
          ...
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a href="{{ url('/siswa/upload') }}" class="flex items-center gap-3 p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition border border-blue-200">
                <div class="text-left">
              ...
              <a href="{{ url('/siswa/karya') }}" class="flex items-center gap-3 p-4 bg-green-50 hover:bg-green-100 rounded-lg transition border border-green-200">
                <div class="text-left">
