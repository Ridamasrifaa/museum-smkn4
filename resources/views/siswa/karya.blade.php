    ...
    <div class="flex h-screen bg-gray-100">
      ...
      <div class="w-64 bg-gray-900 text-white shadow-lg flex flex-col">
        ...
        <div class="border-t border-gray-700 px-6 py-4">
          ...
          <button type="button" onclick="handleLogout()" class="w-full px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-semibold cursor-pointer text-center">
            Logout
          </button>
        </div>
      </div>
                ...
                <tbody class="divide-y divide-gray-200">
                  ...
                  @forelse($projects as $project)
                    <tr class="hover:bg-gray-50">
                      ...
                      <td class="px-6 py-4">
                        <a href="{{ url('/siswa/karya/detail/'.$project->id) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                          Lihat
                        </a>
                      </td>
                    </tr>
