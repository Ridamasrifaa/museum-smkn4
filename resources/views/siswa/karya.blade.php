                ...
                @forelse ($projects as $project)
                    <div class="bg-white neo-border neo-shadow-sm rounded-2xl p-4">
                        ...
                        <div class="mt-4 flex gap-3">
                            <a href="{{ url('/siswa/karya/detail/' . $project->id) }}"
                                class="flex-1 px-3 py-2.5 bg-[#74B9FF] text-slate-900 text-center text-xs font-black rounded-xl neo-border neo-shadow-sm neo-btn">
                                Lihat
                            </a>
                            <form action="{{ url('/siswa/karya/' . $project->id) }}" method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="w-full px-3 py-2.5 bg-[#FF6B6B] text-slate-900 text-xs font-black rounded-xl neo-border neo-shadow-sm neo-btn cursor-pointer">
                                    Hapus
                                </button>
                            </form>
                        </div>
