...
<body class="bg-gray-100">
        ...
        <div class="w-64 bg-gray-900 text-white shadow-lg flex flex-col">
            ...
            <div class="border-t border-gray-700 px-6 py-4">
                ...
                <button type="button" onclick="handleLogout()"
                    class="w-full px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-semibold cursor-pointer text-center">
                    Logout
                </button>
            </div>
        </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    </th> <!-- <--nanti di td jurusan ini ganti sama dengan kategori saja yaa -->
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Status
                                    </th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Tanggal
                                        Upload</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Aksi
                                    </th>
                                </tr>
                            </thead>
    ...
    <script>
        // SCRIPT LOADING SCREEN ANIMATION
        window.addEventListener("load", function() {
            ...
            setTimeout(() => {
                ...
                }, 300); // Sinkron dengan efek fade-out Tailwind duration-300
            }, 1000);
        });

        // SCRIPT LOGOUT HANDLING WITH POST METHOD
