    ...
    <div class="flex-1 p-4 sm:p-6 md:p-10">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white neo-border neo-shadow-lg rounded-2xl overflow-hidden relative min-h-[300px]">
                ...
                {{-- Header Card --}}
                <div class="px-4 sm:px-6 py-4 sm:py-5 border-b-[3px] border-slate-900 bg-[#FEF3C7]">
                ...
                <div class="p-3 sm:p-6">
                    <div class="overflow-hidden neo-border rounded-xl">
                        <table class="block md:table w-full text-sm text-left">
                            <tbody class="block md:table-row-group divide-y-[3px] divide-slate-900 font-bold">

                                {{-- Judul Karya --}}
                                <tr class="flex flex-col md:table-row bg-white">
                                    <td class="block md:table-cell px-4 md:px-6 pt-3 pb-1 md:py-4 text-[11px] md:text-sm uppercase md:normal-case tracking-wider md:tracking-normal font-black text-slate-500 md:text-slate-900 md:w-1/3 bg-[#F1F5F9] md:border-r-[3px] border-slate-900">Judul Karya</td>
                                    <td class="block md:table-cell px-4 md:px-6 pt-2 pb-3 md:py-4 text-slate-900 font-extrabold">{{ $project->title }}</td>
                                </tr>

                                {{-- Jurusan --}}
                                <tr class="flex flex-col md:table-row bg-white">
                                    <td class="block md:table-cell px-4 md:px-6 pt-3 pb-1 md:py-4 text-[11px] md:text-sm uppercase md:normal-case tracking-wider md:tracking-normal font-black text-slate-500 md:text-slate-900 md:w-1/3 bg-[#F1F5F9] md:border-r-[3px] border-slate-900">Jurusan</td>
                                    <td class="block md:table-cell px-4 md:px-6 pt-2 pb-3 md:py-4">
                                ...
                                {{-- Deskripsi --}}
                                <tr class="flex flex-col md:table-row bg-white">
                                    <td class="block md:table-cell px-4 md:px-6 pt-3 pb-1 md:py-4 text-[11px] md:text-sm uppercase md:normal-case tracking-wider md:tracking-normal font-black text-slate-500 md:text-slate-900 md:w-1/3 bg-[#F1F5F9] md:border-r-[3px] border-slate-900">Deskripsi</td>
                                    <td class="block md:table-cell px-4 md:px-6 pt-2 pb-3 md:py-4 leading-relaxed text-slate-800">{{ $project->description }}</td>
                                </tr>

                                {{-- URL Project --}}
                                <tr class="flex flex-col md:table-row bg-white">
                                    <td class="block md:table-cell px-4 md:px-6 pt-3 pb-1 md:py-4 text-[11px] md:text-sm uppercase md:normal-case tracking-wider md:tracking-normal font-black text-slate-500 md:text-slate-900 md:w-1/3 bg-[#F1F5F9] md:border-r-[3px] border-slate-900">URL Project</td>
                                    <td class="block md:table-cell px-4 md:px-6 pt-2 pb-3 md:py-4">
                                ...
                                @if ($isPplg)
                                    <tr class="flex flex-col md:table-row bg-white">
                                        <td class="block md:table-cell px-4 md:px-6 pt-3 pb-1 md:py-4 text-[11px] md:text-sm uppercase md:normal-case tracking-wider md:tracking-normal font-black text-slate-500 md:text-slate-900 md:w-1/3 bg-[#F1F5F9] md:border-r-[3px] border-slate-900">URL GitHub</td>
                                        <td class="block md:table-cell px-4 md:px-6 pt-2 pb-3 md:py-4">
                                ...
                                {{-- Dokumentasi Project --}}
                                <tr class="flex flex-col md:table-row bg-white">
                                    <td class="block md:table-cell px-4 md:px-6 pt-3 pb-1 md:py-4 text-[11px] md:text-sm uppercase md:normal-case tracking-wider md:tracking-normal font-black text-slate-500 md:text-slate-900 md:w-1/3 bg-[#F1F5F9] md:border-r-[3px] border-slate-900">Dokumentasi Project</td>
                                    <td class="block md:table-cell px-4 md:px-6 pt-2 pb-3 md:py-4">
                                ...
                                <tr class="flex flex-col md:table-row {{ $note['row'] }}">
                                    <td class="block md:table-cell px-4 md:px-6 pt-3 pb-1 md:py-4 text-[11px] md:text-sm uppercase md:normal-case tracking-wider md:tracking-normal font-black md:w-1/3 md:border-r-[3px] border-slate-900 {{ $note['label'] }}">Catatan / Alasan Admin</td>
                                    <td class="block md:table-cell px-4 md:px-6 pt-2 pb-3 md:py-4">
