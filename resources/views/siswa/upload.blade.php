        ...
        <div class="flex-1 overflow-auto flex flex-col">
            ...
            <div class="flex-1 overflow-auto p-8 relative">
                ...
                <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-8">
                    <form id="uploadForm" method="POST" action="{{ url('/siswa/upload') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="title" required value="{{ old('title') }}"
                                placeholder="Contoh: Game Android Tebak Kata"
                        ...
                        <div>
                            ...
                            <textarea name="description" required rows="4" placeholder="Jelaskan Hasil karya yang telah anda buat....."
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Link Repository (GitHub/GitLab)
                                / Link Url Sudah Di Deploy *</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Gambar Preview / Screenshot
                                *</label>
                        ...
                        <div class="border border-gray-200 rounded-lg bg-gray-50 p-4 space-y-3">
                            ...
                            <ul class="text-xs text-gray-600 list-disc list-inside space-y-1">
                                <li>Karya atau kode program harus asli hasil buatan sendiri/tim kelompok (bukan
                                    plagiat).</li>
                                <li>Link repository GitHub/GitLab harus bersifat publik agar bisa diperiksa oleh Admin.
                                </li>
                                <li>Karya yang melanggar hak cipta atau mengandung konten negatif akan langsung dihapus.
                                </li>
                            </ul>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <label for="agreeCheckbox"
                                    ...
                                    Saya menyetujui semua syarat dan ketentuan di atas serta menjamin bahwa project yang
                                    saya upload adalah karya asli saya sendiri.
                                </label>
                            </div>
                        </div>
