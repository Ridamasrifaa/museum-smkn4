...
<head>
    ...
    <title>Tim PPLG Raih Juara 1 Lomba Aplikasi Tingkat Provinsi - Museum Karya SMKN 4 Tasikmalaya</title>
...
<body class="scroll-smooth bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <div class="bg-gray-50 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 py-3 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span class="mx-1">/</span>
            <span class="text-gray-700 dark:text-gray-300">Prestasi</span>
        </div>
    </div>
    ...
    <section class="py-10 lg:py-14">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 grid lg:grid-cols-3 gap-12">
            ...
            <article class="lg:col-span-2">
                ...
                <span class="badge-custom mb-4">🏆 Prestasi</span>

                <h1 class="text-2xl lg:text-4xl font-bold text-gray-900 dark:text-white leading-snug mt-3 mb-4">
                    Tim PPLG SMKN 4 Tasikmalaya Raih Juara 1 Lomba Aplikasi Tingkat Provinsi
                </h1>
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400 mb-6 pb-6 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <span class="font-medium text-gray-700 dark:text-gray-300">Tim Redaksi</span>
                    <span>•</span>
                ...
                <div class="w-full h-56 sm:h-80 lg:h-96 rounded-2xl overflow-hidden mb-8 article-thumb">
                    <div class="w-full h-full gradient-cyan flex items-center justify-center">
                ...
                <div class="article-content text-gray-700 dark:text-gray-300">
                    ...
                    <blockquote>
                        Aplikasi "Museum Karya" yang dikembangkan siswa kelas XII PPLG berhasil menyabet
                        juara pertama dalam ajang Lomba Kompetensi Siswa (LKS) tingkat provinsi Jawa Barat.
                    </blockquote>

                    <p>
                        Tim Programmer Perangkat Lunak dan Gim (PPLG) SMKN 4 Tasikmalaya kembali mengukir prestasi
                        membanggakan. Dalam ajang Lomba Kompetensi Siswa (LKS) tingkat provinsi Jawa Barat yang
                        digelar pekan lalu, tim yang beranggotakan lima siswa kelas XII ini berhasil meraih
                        juara pertama kategori Pengembangan Aplikasi, mengalahkan puluhan sekolah lain se-Jawa Barat.
                    </p>

                    <p>
                        Aplikasi yang mereka kembangkan, "Museum Karya", merupakan platform digitalisasi
                        karya siswa yang memungkinkan hasil proyek Teaching Factory dipamerkan secara daring
                        dan dapat diakses oleh siapa saja. Juri menilai aplikasi ini unggul dari sisi kegunaan,
                        desain antarmuka, serta relevansi terhadap kebutuhan sekolah.
                    </p>

                    <h2>Perjalanan Menuju Juara</h2>
                    <p>
                        Persiapan tim dimulai sejak tiga bulan sebelum lomba berlangsung. Di bawah bimbingan
                        guru pembimbing jurusan, para siswa membagi tugas sesuai peran masing-masing mulai dari
                        perancangan basis data, tampilan antarmuka, hingga pengujian aplikasi sebelum hari-H.
                    </p>

                    <p>
                        Berikut tahapan yang dilalui tim selama proses pengembangan aplikasi hingga lomba:
                    </p>

                    <ol>
                        <li>Menentukan konsep dan kebutuhan aplikasi bersama guru pembimbing.</li>
                        <li>Merancang alur pengguna (user flow) dan tampilan (UI/UX) aplikasi.</li>
                        <li>Membangun sistem backend dan basis data untuk menyimpan data karya siswa.</li>
                        <li>Melakukan pengujian aplikasi secara berkala untuk memastikan tidak ada bug.</li>
                        <li>Melakukan simulasi presentasi sebelum tampil di hadapan juri.</li>
                    </ol>

                    <h2>Apresiasi dari Sekolah</h2>
                    <p>
                        Kepala sekolah menyampaikan apresiasi tinggi atas pencapaian tim dan berharap prestasi
                        ini dapat memotivasi siswa lain untuk terus berinovasi. Ke depan, aplikasi Museum Karya
                        rencananya akan terus dikembangkan dan digunakan secara resmi oleh sekolah untuk
                        mendokumentasikan seluruh hasil karya siswa dari berbagai jurusan.
                    </p>

                    <p>
                        Dengan pencapaian ini, tim PPLG SMKN 4 Tasikmalaya akan mewakili Jawa Barat pada ajang
                        LKS tingkat nasional yang dijadwalkan berlangsung pada akhir tahun ini.
                    </p>
                ...
                <div class="flex flex-wrap gap-2 mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
                    <span class="px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-xs font-medium text-gray-600 dark:text-gray-300">#PPLG</span>
                    <span class="px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-xs font-medium text-gray-600 dark:text-gray-300">#LKS2026</span>
                    <span class="px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-xs font-medium text-gray-600 dark:text-gray-300">#Prestasi</span>
                </div>
            ...
            <aside class="space-y-10">
                <div>
                    ...
                    <div class="flex flex-col gap-2">
                        <a href="#" class="flex items-center justify-between px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-950 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 transition">
                            <span>Prestasi</span><span class="text-xs text-gray-400">8</span>
                        </a>
                        <a href="#" class="flex items-center justify-between px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-950 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 transition">
                            <span>Kegiatan</span><span class="text-xs text-gray-400">12</span>
                        </a>
                        <a href="#" class="flex items-center justify-between px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-950 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 transition">
                            <span>Teaching Factory</span><span class="text-xs text-gray-400">5</span>
                        </a>
                        <a href="#" class="flex items-center justify-between px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-950 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 transition">
                            <span>Pengumuman</span><span class="text-xs text-gray-400">3</span>
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-4">
                        <a href="#" class="flex items-start gap-3 group">
                            <span class="text-2xl font-black text-blue-100 dark:text-blue-900 leading-none w-8 flex-shrink-0">01</span>
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 group-hover:text-blue-600 transition line-clamp-2">
                                Tim PPLG Raih Juara 1 Lomba Aplikasi Tingkat Provinsi
                            </p>
                        </a>
                        <a href="#" class="flex items-start gap-3 group">
                            <span class="text-2xl font-black text-blue-100 dark:text-blue-900 leading-none w-8 flex-shrink-0">02</span>
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 group-hover:text-blue-600 transition line-clamp-2">
                                Game Buatan Siswa Tembus 1.000 Unduhan
                            </p>
                        </a>
                        <a href="#" class="flex items-start gap-3 group">
                            <span class="text-2xl font-black text-blue-100 dark:text-blue-900 leading-none w-8 flex-shrink-0">03</span>
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 group-hover:text-blue-600 transition line-clamp-2">
                                Pameran Teaching Factory 2026 Digelar
                            </p>
                        </a>
                    </div>
                </div>
    ...
    <section class="py-14 bg-gray-50 dark:bg-gray-900">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="#" class="related-card group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-5">
                        <span class="badge-custom mb-3">Kegiatan</span>
                        <h3 class="font-bold text-gray-900 dark:text-white group-hover:text-blue-600 transition line-clamp-2 mb-1">
                            Pameran Teaching Factory 2026 Pamerkan Puluhan Karya Siswa
                        </h3>
                        <p class="text-xs text-gray-400">20 Jun 2026</p>
                    </div>
                </a>
                ...
                <a href="#" class="related-card group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-5">
                        <span class="badge-custom mb-3">Prestasi</span>
                        <h3 class="font-bold text-gray-900 dark:text-white group-hover:text-blue-600 transition line-clamp-2 mb-1">
                            Game Buatan Siswa Kelas XII Tembus 1.000 Unduhan di Play Store
                        </h3>
                        <p class="text-xs text-gray-400">1 Jun 2026</p>
                    </div>
                </a>
                ...
                <a href="#" class="related-card group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-5">
                        <span class="badge-custom mb-3">Tefa</span>
                        <h3 class="font-bold text-gray-900 dark:text-white group-hover:text-blue-600 transition line-clamp-2 mb-1">
                            Siswa Kelas XI Resmi Mulai Program Teaching Factory Semester Ini
                        </h3>
                        <p class="text-xs text-gray-400">12 Jun 2026</p>
                    </div>
                </a>
