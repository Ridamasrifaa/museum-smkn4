...
@section('content')
    ...
    <div class="neubrutal-card overflow-hidden">
        ...
        <div class="hidden md:block overflow-x-auto">
            <table class="w-full border-collapse">
                ...
                <tbody id="articleTableBody" class="divide-y-2 divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-10 text-gray-500 font-bold">Belum ada artikel.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div id="articleMobileBody" class="block md:hidden divide-y-2 divide-gray-200">
            ...
            @empty
                <div class="p-6 text-center text-gray-500 font-bold">Belum ada artikel.</div>
            @endforelse
        </div>
    </div>
@endsection
